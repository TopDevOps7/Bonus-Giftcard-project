...
import { TextField, InputAdornment, Button, Menu, Divider, NativeSelect, withStyles } from "@material-ui/core";
import {
  some,
  find,
  reduce,
...
class MaterialUiPhoneNumber extends React.Component {
  ...
  constructor(props) {
    ...
    if (inputNumber.length > 1) {
      ...
      countryGuess =
        this.guessSelectedCountry(inputNumber.replace(/\D/g, "").substring(0, 6), onlyCountries, props.defaultCountry) || 0;
  ...
  handleKeydown = (e) => {
    const { anchorEl, highlightCountryIndex, preferredCountries, onlyCountries, queryString, debouncedQueryStingSearcher } =
      this.state;
