    ...
    <div className={classes.root}>
      <div className={classes.leftSide}>
        <div className={classes.leftBody}>
          {!success && (
            <>
              <h3 className={classes.leftTitle}>Detalles de facturación</h3>
              <TextField
                className={classNames(classes.width100, classes.marginY2)}
                margin="dense"
                variant="outlined"
                label="Dirección"
              />
              ...
              <div className={classNames(classes.twoInput)} style={{ marginTop: 7 }}>
                <TextField
              ...
              <Button color="primary" style={{ float: "right", width: 200 }} onClick={() => setSuccess(true)}>
                PAGAR
              </Button>
            </>
          )}
