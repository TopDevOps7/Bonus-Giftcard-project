 ...
 * ^Filter action types
 */
export const FILTER_CARDS_BY_CATEGORY = "FILTER_CARDS_BY_CATEGORY";
export const FILTER_CARDS_BY_NAME = "FILTER_CARDS_BY_NAME";
export const FILTER_CARDS_BY_PRICE = "FILTER_CARDS_BY_PRICE";
